...
public class ARG_Movement extends ArgumentModule
{
	private SAJ plugin;
	
	public ARG_Movement(ArgumentConstructor argumentConstructor) 
	{
	...
	public void run(CommandSender sender, String[] args) throws IOException 
	{
		...
		new BukkitRunnable() 
		{
			...
			public void run() 
			{
				StatisticCommandExecutor.args(player, args, SortingType.MOVEMENT);
			}
