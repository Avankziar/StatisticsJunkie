...
public class ARG_Miscellaneous extends ArgumentModule
{
	private SAJ plugin;
	
	public ARG_Miscellaneous(ArgumentConstructor argumentConstructor) 
	{
	...
	public void run(CommandSender sender, String[] args) throws IOException 
	{
		...
		new BukkitRunnable() 
		{
			...
			public void run() 
			{
				StatisticCommandExecutor.args(player, args, SortingType.MISCELLANEOUS);
			}
