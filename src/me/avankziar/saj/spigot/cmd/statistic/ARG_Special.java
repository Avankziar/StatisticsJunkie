...
public class ARG_Special extends ArgumentModule
{
	private SAJ plugin;
	
	public ARG_Special(ArgumentConstructor argumentConstructor) 
	{
	...
	public void run(CommandSender sender, String[] args) throws IOException 
	{
		...
		new BukkitRunnable() 
		{
			...
			public void run() 
			{
				StatisticCommandExecutor.args(player, args, SortingType.SPECIAL);
			}
