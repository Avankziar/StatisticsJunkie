...
public class ARG_Time extends ArgumentModule
{
	private SAJ plugin;
	
	public ARG_Time(ArgumentConstructor argumentConstructor) 
	{
	...
	public void run(CommandSender sender, String[] args) throws IOException 
	{
		...
		new BukkitRunnable() 
		{
			...
			public void run() 
			{
				StatisticCommandExecutor.args(player, args, SortingType.TIME);
			}
