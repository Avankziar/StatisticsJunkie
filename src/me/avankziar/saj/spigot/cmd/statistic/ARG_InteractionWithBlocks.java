...
public class ARG_InteractionWithBlocks extends ArgumentModule
{
	private SAJ plugin;
	
	public ARG_InteractionWithBlocks(ArgumentConstructor argumentConstructor) 
	{
	...
	public void run(CommandSender sender, String[] args) throws IOException 
	{
		...
		new BukkitRunnable() 
		{
			...
			public void run() 
			{
				StatisticCommandExecutor.args(player, args, SortingType.INTERACTION_WITH_BLOCKS);
			}
