...
public class ARG_Plugins extends ArgumentModule
{
	private SAJ plugin;
	
	public ARG_Plugins(ArgumentConstructor argumentConstructor) 
	{
	...
	public void run(CommandSender sender, String[] args) throws IOException 
	{
		...
		new BukkitRunnable() 
		{
			...
			public void run() 
			{
				StatisticCommandExecutor.args(player, args, SortingType.PLUGINS);
			}
